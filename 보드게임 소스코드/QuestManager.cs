...
namespace Rito.InventorySystem.Quest
{
    public class QuestManager : MonoBehaviour
    {
        ...
        public int randomTextIndex;
        public List<string> remainingTexts = null;
        public List<(string, int)> Reward_3rd;
        private ColorBlock NormalColor; // 원래 색상을 저장할 변수
        private List<(string, int)> itemName;
        private List<string> Quest_1st = new List<string>
        {
        ...
        void SetRandomText(TMP_Text textComponent, List<string> remainingTexts)
        {
            ...
            randomTextIndex = UnityEngine.Random.Range(0, remainingTexts.Count);
            textComponent.text = remainingTexts[randomTextIndex];
        }
