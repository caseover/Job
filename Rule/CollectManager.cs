...
//         material = FindFirstObjectByType<material>();
...
//         collectButton.interactable = false;
//     }
//     public void CollectMatterial()
//     {
//         if (currentNode != null && currentNode.elementNodeType == ElementNodeType.Forest)
//         {
//             int index = UnityEngine.Random.Range(0, material.forest.Count);
//             string item = material.forest[index];
//             inventory.Inven.Add(item);
//             Debug.Log("Added " + item + " to inventory from forest.");
//             player.ps.AP -= 1;
//             // DeActiveButton();
//         }
//         else if (currentNode != null && currentNode.elementNodeType == ElementNodeType.Mine)
//         {
//             int index = UnityEngine.Random.Range(0, material.mine.Count);
//             string item = material.mine[index];
//             inventory.Inven.Add(item);
//             Debug.Log("Added " + item + " to inventory from mine.");
//             player.ps.AP -= 1;
//             // DeActiveButton();
//         }    
//     }
...
//                     inventory.Inven.Add(forestItem);
//                     Debug.Log("Added " + forestItem + " to inventory from forest.");
//                     break;
//                 case ElementNodeType.Mine:
//                     int mineIndex = Random.Range(0, material.mine.Count);
//                     string mineItem = material.mine[mineIndex];
//                     inventory.Inven.Add(mineItem);
//                     Debug.Log("Added " + mineItem + " to inventory from mine.");
//                     break;
//             }
